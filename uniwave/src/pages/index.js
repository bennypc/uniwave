              ...
              <main className="lg:col-span-9 xl:col-span-6">
                <div className="px-4 sm:px-0">
                  <div className="sm:hidden">
                    ...
                    <select
                      id="question-tabs"
                      className="block w-full rounded-md border-gray-300 text-base font-medium text-gray-900 shadow-sm focus:border-[#0055B7] focus:ring-[#0055B7]"
                      ...
                      {tabs.map((tab, tabIdx) => (
                        ...
                        >
                          ...
                          <span
                            aria-hidden="true"
                            className={classNames(
                              tab.current ? 'bg-[#0055B7]' : 'bg-transparent',
